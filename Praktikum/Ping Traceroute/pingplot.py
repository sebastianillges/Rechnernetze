...
plt.plot(timesHTWG, label="HTWG", linewidth=0.7)
plt.plot(timesNsa, label="NSA", linewidth=0.7)
plt.plot(timesStackoverflow, label="Stackoverflow", linewidth=0.7)
plt.plot(timesSydney, label="Sydney", linewidth=0.7)
plt.legend(loc="best")
